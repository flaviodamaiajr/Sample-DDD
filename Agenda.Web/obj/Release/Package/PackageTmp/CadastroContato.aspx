...
<body>
        ...
        <form id="formCadastroContato" class="form-horizontal" runat="server">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <a href="#" id="btnSalvar" class="btn btn-success">Salvar</a>
                        <a href="#" id="btnExlcuir" class="btn btn-danger">Excluir</a>
    ...
    <script type="text/javascript">
        ...
        $("#btnExcluir").click(function (event) {
            ...
            $.ajax({
                type: "POST",
                url: "CadastroContato.aspx/ExcluirContato",
                contentType: "application/json;charset=utf-8",
                dataType: "json",
                data: JSON.stringify($('form#formCadastroContato').serializeObject()),
                timeout: 10000,
                ...
                success: function (data) {
                    $("div#mensagem").removeClass();
                    $("div#mensagem").addClass('alert alert-success');
                    $('#mensagem').html(data);
                    redirecionamento();
                }
            });
