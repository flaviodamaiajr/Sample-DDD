    ...
    <div class="container">
        ...
        <form id="formConsulta" runat="server">
            <div class="well well-sm">
                <a href="CadastroContato.aspx" class="btn btn-success btn-sm"><i class='glyphicon glyphicon-plus-sign'></i> Novo Contato</a>
                <a href="#" class="btn btn-primary btn-sm" onclick="ListarContatos();"><i class='glyphicon glyphicon-refresh'></i> Atualizar</a>
            </div>
            <div id="agenda">
            </div>
        </form>
